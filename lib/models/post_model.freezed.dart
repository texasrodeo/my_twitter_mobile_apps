...
abstract class $PostModelCopyWith<$Res> {
  ...
  $Res call({String id, String text, String imageUrl, LikeStatus? likeStatus});
}
...
class _$_PostModel implements _PostModel {
  ...
  @override
  String toString() {
    return 'PostModel(id: $id, text: $text, imageUrl: $imageUrl, likeStatus: $likeStatus)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, text, imageUrl, likeStatus);
...
abstract class _PostModel implements PostModel {
  const factory _PostModel(
      ...
      required String text,
      required String imageUrl,
      LikeStatus? likeStatus}) = _$_PostModel;
